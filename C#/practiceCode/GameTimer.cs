...
namespace SrcChess2.Core {
    ...
    public class GameTimer {
        ...
        public TimeSpan? MaxWhitePlayTime {
            get => m_maxWhiteTime == TimeSpan.MinValue ? null : m_maxWhiteTime;
            set {
                m_maxWhiteTime = value ?? throw new ArgumentNullException(nameof(MaxWhitePlayTime));
            }
        }
        ...
        public TimeSpan? MaxBlackPlayTime {
            get => m_maxBlackTime == TimeSpan.MinValue ? null : m_maxBlackTime;
            set {
                m_maxBlackTime = value ?? throw new ArgumentNullException(nameof(MaxBlackPlayTime));
            }
        }
